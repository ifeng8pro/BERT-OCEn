...
class R8_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='bert', use_tfidf_weights=False, append_sos=False,
        ...
        classes = ['earn', 'money-fx', 'interest','ship','acq','crude', 'trade','grain']
        # classes_full_list = [
        ...
        self.train_set, self.test_set = r8_dataset(directory=root, train=True, test=True, clean_txt=clean_txt)
...
def r8_dataset(directory='../data', train=True, test=False, clean_txt=False, train_proportion=10):
    """
    Load and preprocess the r8 dataset for text classification.
