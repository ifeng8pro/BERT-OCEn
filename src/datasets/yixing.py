...
class Yixing_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, train_proportion=10,tokenizer='bert', use_tfidf_weights=False, append_sos=False,
        ...
        """
        classes = ['公务接待', '公务用车', '会议培训', '人员薪酬', '物业管理', '设备/服务采购', '空']
        ...
        self.train_set, self.test_set = yx23_dataset(directory=root, train=True, test=True, clean_txt=clean_txt, train_proportion=train_proportion)
...
def yx23_dataset(directory='../data', train=True, test=False, clean_txt=False, train_proportion=10):
    """
    Load and preprocess the yixing dataset for text classification.
